...
PARAMS = -MObjFPC -Scgi -Cg -O1 -g -Xg -XX -l -vewnhibq -Filib/$(LCL_PLATFORM) -Fu/$(LCL_PLATFORM)/gtk2 -Fu/usr/lib/lazarus/2.0.0/lcl/units/$(LCL_PLATFORM)/gtk2 -Fu/usr/lib/lazarus/2.0.0/lcl/units/$(LCL_PLATFORM) -Fu/usr/lib/lazarus/2.0.0/components/lazutils/lib/$(LCL_PLATFORM) -Fu/usr/lib/lazarus/2.0.0/packager/units/$(LCL_PLATFORM) -Fu. -FUlib/$(LCL_PLATFORM) -FE. -oproject1 -dLCL -dLCLgtk2 -Fo/usr/lib/$(LCL_PLATFORM)-gnu/fpc/3.0.4/units/$(LCL_PLATFORM)/chm -Fu/usr/lib/$(LCL_PLATFORM)-gnu/fpc/3.0.4/units/$(LCL_PLATFORM)/chm
